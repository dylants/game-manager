 ...
 *                          callback(err, game)
 */
NBAGameBuilder.prototype.buildGame = function(app, date, time, teams, location, description, callback) {
    ...
    this.findGame(gameTimeUTC, awayTeamName, homeTeamName, location, networks,
